...
public class beginner extends AppCompatActivity {
            ...
            public void onClick(View v) {
                ...
                new CountDownTimer(30000, 1000){
                    ...
                    public void onFinish(){
                        ...
                        results.setText(String.format("You answered %d out of %d beginner questions correctly in 30 seconds!", correct, correct + incorrect));
    ...
    public void generateBegProblem(View view) {
