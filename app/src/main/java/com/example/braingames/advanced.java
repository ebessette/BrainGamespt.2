...
public class advanced extends AppCompatActivity {
            ...
            public void onClick(View v) {
                ...
                new CountDownTimer(30000, 1000) {
                    ...
                    public void onFinish() {
                        ...
                        results.setText(String.format("You answered %d out of %d advanced questions correctly in 30 seconds!", correct, correct + incorrect));
    ...
    public void generateAdvProblem(View view) {
        int num1 = rand.nextInt(35);
        int num2 = rand.nextInt(35);
